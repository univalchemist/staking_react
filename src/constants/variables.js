...
export const CotractAddressesTestnet = {
  ...
  guaranteedApyStaking: '0xFDCC8ae68b7680903323e5041AE42f6A7Dc77122',
...
export const NETWORK_CHAIN_ID = config.isMainnet ? NETWORKS_CHAINS.BSC_CHAIN_ID : NETWORKS_CHAINS.BSC_TEST_CHAIN_ID;
