    ...
    currentData && (
      <>
        <div className={classes.row}>
          <div className={classes.info}>
            <Title color="textPrimary">
              {Utils.formatNumberWithCommas(currentData.balance, 2)}
            </Title>
        ...
        <div className={classes.row}>
          <div className={classes.info}>
            <Title color="textPrimary">
              {Utils.formatNumberWithCommas(currentData.staked, 2)}
            </Title>
            <Tiny className={classes.description}>
          ...
          <div className={classes.button}>
            {!data.limit && currentData.canWithdraw && (
              <Button
        ...
        <div className={classes.row}>
          <div className={classes.info}>
            <Title color="textPrimary">
              {Utils.formatNumberWithCommas(currentData.earned, 2)}
            </Title>
            <Tiny className={classes.description}>
              {data.limit ? 'Your reward' : 'LACE Earned'}
            </Tiny>
          </div>
          <div className={data.limit ? classes.longButton : classes.button}>
            <Button
            ...
            >
              {data.limit ? 'Unstake and Collect' : 'Collect'}
            </Button>
          </div>
        </div>
      </>
